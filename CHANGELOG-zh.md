...
### 新增
- **Skill 自动检查更新** —— 新增 **设置 → Skill 自动更新** 面板，可按 6 小时 / 每天 / 每周 在后台自动检查已安装 Skill 是否有上游更新（默认关闭）。发现新版本时会弹出提示，并在「我的 Skills」顶部点亮 **全部更新** 徽标；不会自动覆写 Skill 内容，仍需手动确认实际更新。面板同时展示上次检查时间，并提供 **立即检查** 按钮。
